...
{
    SECTION("find_compression_method, by method")
    {
        constexpr auto unknown_method = compression_method(-1);

        CHECK(find_compression_method(compression_method::lzss)->method == compression_method::lzss);
        CHECK(find_compression_method(compression_method::d16)->method == compression_method::d16);
        CHECK(find_compression_method(unknown_method) == nullptr);
    }

    SECTION("find_compression_method, by string")
    {
