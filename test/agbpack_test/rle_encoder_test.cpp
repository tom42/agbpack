...
TEST_CASE("rle_encoder_test")
{
    ...
    SECTION("Successful encoding")
    {
        ...
        string filename_part = GENERATE(
            ...
            // TODO: also test special case of 2 repeated bytes (possibly also followed by something else?)
            "rle.good.3-repeated-bytes.txt"); // TODO: fix encoded file, it is still unpadded!
