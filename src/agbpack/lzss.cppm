...
inline vector<match> choose_matches(const vector<match>& ml)
{
    ...
    vector<size_t> out(ml.size(), 0xbaadf00dbaadf00du); // TODO: initialized for debugging
    vector<match> cml(ml.size(), match(0xbaadf00dbaadf00du, 0xbaadf00dbaadf00du)); // TODO: initialized for debugging
